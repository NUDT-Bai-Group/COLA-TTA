...
os.environ["WANDB_MODE"] = "offline"#wandb offline mode
...
def main(args):
    ...
    #Default setting: Automatically set whether to enable distributed training based on environment variables or distributed training parameters
    args.distributed = args.world_size > 1 or args.multiprocessing_distributed

    # Compatibility setting: Hardcoded to False to force single-GPU mode, ignoring distributed training settings
